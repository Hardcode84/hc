...
typing.type_resolver ["py_ir.getattr", "print_val"] {
  %c0 = arith.constant 0: index
  %0 = typing.make_ident "hckernel.typing" []
  %1 = typing.get_arg %c0
  %2 = typing.is_same %0 %1
  ...
  %3 = typing.make_ident "hckernel.typing.print_val" []
  typing.type_resolver_return %3
}

typing.type_resolver ["py_ir.call"] {
  %c0 = arith.constant 0: index
  %0 = typing.make_ident "hckernel.typing.print_val" []
  %1 = typing.get_arg %c0
  %2 = typing.is_same %0 %1
  typing.check %2
...
typing.type_resolver ["py_ir.getattr", "unpack_seq"] {
  %c0 = arith.constant 0: index
  %0 = typing.make_ident "hckernel.typing" []
  %1 = typing.get_arg %c0
  %2 = typing.is_same %0 %1
  ...
  %3 = typing.make_ident "hckernel.typing.unpack_seq" []
  typing.type_resolver_return %3
}

typing.type_resolver ["py_ir.call"] {
  %c0 = arith.constant 0: index
  %0 = typing.make_ident "hckernel.typing.unpack_seq" []
  %1 = typing.get_arg %c0
  %2 = typing.is_same %0 %1
  typing.check %2
...
// typing.get_metatype_name

typing.type_resolver ["py_ir.getattr", "get_metatype_name"] {
  %c0 = arith.constant 0: index
  %0 = typing.make_ident "hckernel.typing" []
  %1 = typing.get_arg %c0
  %2 = typing.is_same %0 %1
...
typing.type_resolver ["py_ir.call"] {
  %c0 = arith.constant 0: index
  %0 = typing.make_ident "hckernel.typing.get_metatype_name" []
  %1 = typing.get_arg %c0
  %2 = typing.is_same %0 %1
  typing.check %2

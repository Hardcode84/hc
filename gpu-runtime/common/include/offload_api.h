...
OFFLOAD_API_EXPORT OlDevice olCreateDevice(const char *desc,
                                           ...
                                           void *ctx);
OFFLOAD_API_EXPORT void olReleaseDevice(OlDevice dev);
...
OFFLOAD_API_EXPORT OlModule olCreateModule(OlDevice dev, const void *data,
                                           size_t len);
OFFLOAD_API_EXPORT void olReleaseModule(OlModule mod);

OFFLOAD_API_EXPORT OlKernel olGetKernel(OlModule mod, const char *name);
OFFLOAD_API_EXPORT void olReleaseKernel(OlKernel k);
...
// Sync API
OFFLOAD_API_EXPORT OlQueue olCreateSyncQueue(OlDevice dev);
OFFLOAD_API_EXPORT void olReleaseQueue(OlQueue q);

OFFLOAD_API_EXPORT void *olAllocDevice(OlQueue q, size_t size, size_t align);
OFFLOAD_API_EXPORT void olDeallocDevice(OlQueue q, void *data);

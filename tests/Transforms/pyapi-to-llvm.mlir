...
//       CHECK:   %[[D7:.*]] = llvm.call @hcgpuConvertPyArray(%[[ARG0]], %[[D6]], %[[RANK1]], %[[D3]]) : (!llvm.ptr, !llvm.ptr, i32, !llvm.ptr) -> i32
...
//       CHECK:   %[[D13:.*]] = llvm.call @hcgpuConvertPyArray(%[[ARG0]], %[[D12]], %[[RANK2]], %[[D1]]) : (!llvm.ptr, !llvm.ptr, i32, !llvm.ptr) -> i32

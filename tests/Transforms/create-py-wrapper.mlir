...
//   CHECK-DAG:   %[[A1:.*]] = hkernel.get_py_arg %[[ARG1]][1], %[[ARG0]] : !hkernel.memref_descriptor<memref<?x?xi32, strided<[?, ?], offset: ?>>>
//   CHECK-DAG:   %[[A2:.*]] = hkernel.get_py_arg %[[ARG1]][2], %[[ARG0]] : !hkernel.memref_descriptor<memref<?x?xi32, strided<[?, ?], offset: ?>>>

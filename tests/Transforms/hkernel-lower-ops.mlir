...
//       CHECK:  %[[ALLOC1:.*]] = memref.alloca(%[[EXPR_VAL1]]) {kernel.alloc_expand} : memref<?xf16, #gpu.address_space<workgroup>>
...
//       CHECK:  %[[ALLOC2:.*]] = memref.alloca(%[[EXPR_VAL1]]) {kernel.alloc_expand} : memref<?xi1, #gpu.address_space<workgroup>>
